"""
50 curated XAI / Mechanistic Interpretability papers.

Ground truth for question 5.1.3 — appendix-only version.
Two labels only:
  SEPARATE_APPENDIX  — appendix contains structured prompt tables or pseudocode
  MISSING            — no structured preprocessing artefacts in the appendix
"""
...
PAPERS = [
    ...
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "EDGE CASE: Uses NLP-style attention probing on protein language models; preprocessing domain is protein sequences, not NLP text.",
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "EDGE CASE: Benchmarks LLM-based TTS systems; pipeline involves audio generation/evaluation, not NLP text preprocessing.",
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "EDGE CASE: Uses probing on vision transformers for image masking tasks; no NLP text pipeline.",
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "EDGE CASE: LRP variant applied to VGG/ResNet/ViT on ImageNet/PascalVOC — purely image domain, no NLP pipeline.",
    },
    {
    ...
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "Benchmark paper; the benchmark itself is the artefact, not a preprocessing pipeline for an experiment.",
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "EDGE CASE: SAEs applied to VLM image encoders on iNaturalist image data — preprocessing domain is image, not NLP text.",
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "EDGE CASE: MI framing applied to graph transformers on graph-structured data — no NLP/text pipeline.",
    },
    {
    ...
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "EDGE CASE: XAI method evaluated on image classification datasets (MNIST, FMNIST, CIFAR) — no NLP pipeline.",
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "EDGE CASE: Transformer for drug-target interaction; preprocessing is molecular sequences, not NLP text.",
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "EDGE CASE: MI applied to vision transformers using wavelet frequency analysis on image data — no NLP/text pipeline.",
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "Benchmark paper; benchmark construction is the contribution, not a preprocessing pipeline for analysis.",
    },
    {
        ...
        "ground_truth": "MISSING",
        "gt_reason": "Infrastructure/toolkit paper for MI in vision/video domain; no NLP text pipeline.",
    },
    ...
    },
    {
        ...
        "ground_truth": "SEPARATE_APPENDIX",
        "gt_reason": "Appendix contains structured prompt template tables detailing exact input construction per knowledge category.",
    },
    {
    ...
    },
    {
        ...
        "ground_truth": "SEPARATE_APPENDIX",
        "gt_reason": "Appendix includes structured tables of refusal prompt templates and SAE feature labeling pipeline.",
    },
    {
    ...
    },
    {
        ...
        "ground_truth": "SEPARATE_APPENDIX",
        "gt_reason": "Appendix contains structured tables of adversarial prompt constructions and activation patching pipelines.",
    },
    {
